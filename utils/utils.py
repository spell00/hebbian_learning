...
def automatic_labels_from_gse_metadata(gse, merged_values):
    ...
    gse = geo.GEOparse.get_GEO(geo=geo_id,destdir="/Users/simonpelletier/data/hebbian_learning_ann/softs",silent=True)
...
def get_example_datasets(home_folder="/Users/simonpelletier/", results_folder="results", data_folder="data",
                         destination_folder="hebbian_learning_ann", silent=0):
